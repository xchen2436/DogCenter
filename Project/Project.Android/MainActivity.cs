...
namespace Project.Droid
{
    ...
    public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            string dbName = "Admindatabase";
            string foldPath = System.Environment.GetFolderPath(System.Environment.SpecialFolder.Personal);
            string databaseLocationPath = Path.Combine(foldPath, dbName);
